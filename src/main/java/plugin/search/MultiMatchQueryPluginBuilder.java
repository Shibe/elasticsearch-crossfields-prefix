...
public class MultiMatchQueryPluginBuilder extends AbstractQueryBuilder<MultiMatchQueryPluginBuilder> {
    ...
    private static final String CUTOFF_FREQUENCY_DEPRECATION_MSG = "you can omit this option, "
            + "the [multi_match_plugin] query can skip block of documents efficiently if the total number of hits is not tracked";

    public static final String NAME = "multi_match_plugin";

    public static final MultiMatchQueryPluginBuilder.Type DEFAULT_TYPE = MultiMatchQueryPluginBuilder.Type.BEST_FIELDS;
    ...
    public enum Type implements Writeable {
         ...
         * fields into a single field given the configured analysis is identical.
         * This type uses a tie-breaker to adjust the score based on remaining
         * prefix matches per analyzed terms
         */
        CROSS_FIELDS_PREFIX(MatchQueryParser.Type.BOOLEAN, 0.0f, new ParseField("cross_fields_prefix"));
        ...
        public static Type parse(String value, DeprecationHandler deprecationHandler) {
            MultiMatchQueryPluginBuilder.Type[] values = MultiMatchQueryPluginBuilder.Type.values();
            Type type = null;
            for (MultiMatchQueryPluginBuilder.Type t : values) {
     ...
     */
    public MultiMatchQueryPluginBuilder.Type getType() {
        return type;
    }
     ...
     */
    public MultiMatchQueryPluginBuilder(Object value, String... fields) {
        if (value == null) {
     ...
     * Read from a stream.
     */
    public MultiMatchQueryPluginBuilder(StreamInput in) throws IOException {
        super(in);
     ...
     */
    public MultiMatchQueryPluginBuilder field(String field) {
     ...
     */
    public MultiMatchQueryPluginBuilder field(String field, float boost) {
        if (Strings.isEmpty(field)) {
            throw new IllegalArgumentException("supplied field is null or empty.");
        }
        checkNegativeBoost(boost);
     ...
     */
    public MultiMatchQueryPluginBuilder fields(Map<String, Float> fields) {
     ...
     */
    public MultiMatchQueryPluginBuilder type(MultiMatchQueryPluginBuilder.Type type) {
        if (type == null) {
     ...
     * Sets the type of the text query.
     */
    public MultiMatchQueryPluginBuilder type(Object type) {
        if (type == null) {
            throw new IllegalArgumentException("[" + NAME + "] requires type to be non-null");
        }
     ...
     */
    public MultiMatchQueryPluginBuilder operator(Operator operator) {
        if (operator == null) {
     ...
     */
    public MultiMatchQueryPluginBuilder analyzer(String analyzer) {
     ...
     */
    public MultiMatchQueryPluginBuilder slop(int slop) {
        if (slop < 0) {
    ...
    public MultiMatchQueryPluginBuilder prefixLength(int prefixLength) {
        if (prefixLength < 0) {
     ...
     */
    public MultiMatchQueryPluginBuilder maxExpansions(int maxExpansions) {
        if (maxExpansions <= 0) {
    ...
    public MultiMatchQueryPluginBuilder minimumShouldMatch(String minimumShouldMatch) {
    ...
    public MultiMatchQueryPluginBuilder fuzzyRewrite(String fuzzyRewrite) {
     ...
     * @see Type
     */
    public MultiMatchQueryPluginBuilder tieBreaker(float tieBreaker) {
        this.tieBreaker = tieBreaker;
        return this;
    }
     ...
     */
    public MultiMatchQueryPluginBuilder lenient(boolean lenient) {
    ...
    public MultiMatchQueryPluginBuilder zeroTermsQuery(ZeroTermsQueryOption zeroTermsQuery) {
    ...
    public MultiMatchQueryPluginBuilder autoGenerateSynonymsPhraseQuery(boolean enable) {
     ...
     */
    public MultiMatchQueryPluginBuilder fuzzyTranspositions(boolean fuzzyTranspositions) {
    ...
    public static MultiMatchQueryPluginBuilder fromXContent(XContentParser parser) throws IOException {
        Object value = null;
        Map<String, Float> fieldsBoosts = new HashMap<>();
        MultiMatchQueryPluginBuilder.Type type = DEFAULT_TYPE;
        ...
        while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
            if (token == XContentParser.Token.FIELD_NAME) {
                ...
                if (QUERY_FIELD.match(currentFieldName, parser.getDeprecationHandler())) {
                    ...
                    type = MultiMatchQueryPluginBuilder.Type.parse(parser.text(), parser.getDeprecationHandler());
        ...
        if (value == null) {
            throw new ParsingException(parser.getTokenLocation(), "No text specified for multi_match_plugin query");
        }
    ...
    protected Query doToQuery(SearchExecutionContext context) throws IOException {
        MultiMatchQueryPluginParser multiMatchQuery = new MultiMatchQueryPluginParser(context);
        if (analyzer != null) {
    ...
    @Override
    protected boolean doEquals(MultiMatchQueryPluginBuilder other) {
